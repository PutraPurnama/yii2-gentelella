...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?> x_panel">
    <div class="x_title">
        <h2><?= "Daftar ".Inflector::camel2words(StringHelper::basename($generator->modelClass)) ?></h2>
