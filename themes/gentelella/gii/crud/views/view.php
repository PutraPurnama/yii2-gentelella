...
?>
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-view x_panel">
    <div class="x_title">
        <h2>Detail <?= Inflector::camel2words(StringHelper::basename($generator->modelClass)); ?></h2>
